...
def build_poster_banner(anime, photo_bytes, brand, theme_name="green"):
    ...
    f_brand = load_font(15, True)
    draw.text((LEFT, 185), brand.upper(), font=f_brand, fill=ACCENT)
    ...
    # Bottom: circle icon + brand pill
    badge_y  = line_y + 20
    icon_r   = 26
    icon_cx  = LEFT + icon_r
    icon_cy  = badge_y + icon_r
    ...
    pill_text = brand.upper()
    ptw = draw.textbbox((0,0), pill_text, font=f_pill)[2]
    pill_x = icon_cx + icon_r + 6
    pill_w = ptw + 32; pill_h2 = icon_r * 2
    pill_y = icon_cy - icon_r
