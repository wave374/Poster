...
def build_poster(anime: dict, photo_bytes: bytes, brand: str, theme_name: str = "green") -> bytes:
    ...
    if subtitle:
        ...
        draw.text((38, title_bottom + 2), subtitle.upper(), font=f_sub, fill=ACCENT)
        title_bottom = draw.textbbox((38, title_bottom + 2), subtitle.upper(), font=f_sub)[3]
